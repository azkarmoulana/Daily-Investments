...
public class Example extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            DatabaseMetaData metaData = databaseConfig.getConnection().getMetaData();
            ResultSet foreignKeys = metaData.getImportedKeys(databaseConfig.getConnection().getCatalog(), null, "customers");
            while (foreignKeys.next()) {
                String fkTableName = foreignKeys.getString("FKTABLE_NAME");
                String fkColumnName = foreignKeys.getString("FKCOLUMN_NAME");
                String pkTableName = foreignKeys.getString("PKTABLE_NAME.name");
